...
Утилиты прежнего external Web-слоя сохранены только в репозитории для совместимости и тестов миграции. В автономный пакет `10.11.0.7` они не включены.
...
5. Подготовлен отдельный каталог `КиноПоиск_10.11.0.7`.
...
15. Подтверждена загрузка версии `10.11.0.7` без критических ошибок DI/assembly loading.
